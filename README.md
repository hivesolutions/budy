...
| Name                       | Type    | Description                                                                                                                                                                                                                                                            |
| -------------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **BUDY_PAYMENT_PROVIDERS** | `list`  | The list of payment providers that are going to be loaded in the Budy instance (defaults to `["stripe", "easypay", "paypal", "stripe_sca"]`).                                                                                                                          |
