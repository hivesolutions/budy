...
class AccountAPIController(root.RootAPIController):
    ...
    def addresses_me(self):
        account = budy.BudyAccount.from_session(eager=("addresses",), map=True)
    ...
    def simple_csv(self):
        ...
        accounts = budy.BudyAccount.find(**object)

        accounts_s = [("username", "email", "first_name", "last_name", "birth_date")]
